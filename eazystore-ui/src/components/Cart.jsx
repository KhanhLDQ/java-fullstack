...
export default function Cart() {
  //allow to change the page programmatically without using <Link>
  // const navigation = useNavigate();
  // const handleClick = () => {
  //   navigation("/home", { state: { username: "Tom" } }); //navigate with parameters
  // };
  ...
  return (
    <div className="min-h-[852px] py-12 bg-normalbg dark:bg-darkbg font-primary">
      <div className="max-w-4xl mx-auto px-4">
        ...
        {!isCartEmpty ? (
          // React fragment -> group multiple elements without adding an extra DOM node
          <>
            <CartTable />
