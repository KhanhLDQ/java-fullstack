...
export default function Contact() {
  ...
  const formRef = useRef(null); //maintain data but not trigger the re-rendering process
  ...
  const handleSubmit = (event) => {
    //action -> if you do not have any custom business logic to be executed & auto submit form without any validations
    //useSubmit hook -> if you want to submit form manually & more control
    event.preventDefault(); //browser immediately submit form & refresh the page by default -> stop that behavior
    ...
    if (userConfirmed) {
      ...
      submit(formData, { method: "POST" }); //submit form
    } else {
